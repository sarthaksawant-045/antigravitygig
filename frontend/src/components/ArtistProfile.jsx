...
export default function ArtistProfile() {
  ...
  return (
    <main className="ap-wrap ap-page-animate">
          ...
          <div className="ap-hero-content">
            ...
            <div className="ap-header-details">
              ...
              <div className="ap-meta">
                ...
                <span>💰 {profile.priceRange || "Price not specified"}</span>
              </div>
            </div>
          </div>
      ...
      <div className="ap-body grid">
        <div className="ap-main-col">
          <section className="ap-section ap-card ap-fade-card">
            <h3>About the Artist</h3>
            {profile.dob && (
              <p className="ap-sub-meta">
                <strong>Date of Birth:</strong> {profile.dob}
              </p>
            )}
            <p className="ap-body-copy">{profile.description || "No bio provided."}</p>
          </section>

          <section className="ap-section ap-card ap-fade-card">
            <h3>Portfolio</h3>
            {portfolioItems.length === 0 ? (
              <div className="ap-portfolio-empty">
                <div className="ap-portfolio-empty-icon">📁</div>
                <div className="ap-portfolio-empty-title">No portfolio uploaded yet</div>
                <p>No showcase work has been added to this profile yet.</p>
              </div>
            ) : (
              <div className="ap-portfolio-grid">
                {portfolioItems.map((item, index) => {
                  ...
                  return (
                    <div key={item.id || item.portfolio_id || index} className="ap-portfolio-card">
                      <img
                        src={imageSrc}
                        alt={item.title || "Portfolio item"}
                        className="ap-portfolio-card-image"
                      />
                      <div className="ap-portfolio-card-body">
                        <h4>{item.title}</h4>
        ...
        <aside className="ap-side-col">
          ...
          <section className="ap-section ap-card ap-guarantee ap-fade-card">
            <h4><span className="ap-guarantee-ico">🛡️</span> GigBridge Protected</h4>
            ...
            <form onSubmit={handleHireSubmit} style={{ display: "flex", flexDirection: "column", gap: "0.75rem" }}>
              ...
              {freelancerPricingType === "per_person" && (
                <label>
                  ...
                  <input
                    ...
                    min="1"
                    required
                    value={hireForm.number_of_persons}
                    placeholder="e.g., 5"
              ...
              {freelancerPricingType === "package" && (
                <label>
                  ...
                  <select
                    required
                    value={hireForm.selected_package_id}
