...
export default function HireRequestCard({ data, onDecline }) {
  return (
    <div className="opp-card">
      ...
      <div className="opp-details">
        <div className="opp-detail-item">💰 {data.budget}</div>
        <div className="opp-detail-item">🕒 {data.timeline}</div>
        <div className="opp-detail-item">📍 {data.location}</div>
      </div>
      ...
      <div className="opp-actions">
        <button className="db-primary" style={{ height: '40px', padding: '0 24px', borderRadius: '10px' }}>
          ✓ Accept
        </button>
        <button 
